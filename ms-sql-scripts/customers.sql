SELECT [CUS].[DataAreaID]                        AS [Company_ID]
  ...
  FROM [dbo].[McaCustTableStaging] AS [CUS]

       -- CUSTOMER NAME LOOKUP
       LEFT JOIN [dbo].[McaDirPartyTableStaging] AS [CUS_NME]
              ON [CUS_NME].[RecID]     = [CUS].[Party]
             AND [CUS_NME].[Partition] = [CUS].[Partition]

       -- CUSTOMER SALES POOL LOOKUP
       LEFT JOIN [dbo].[McaSalesPoolStaging] AS [CUS_SLE_SPL]
       ...
       LEFT JOIN [dbo].[McaHcmWorkerStaging] AS [CUS_EMP_RES]
       ...
       LEFT JOIN [dbo].[McaPaymTermStaging] AS [CUS_PAY_TRM]
       ...
       LEFT JOIN [dbo].[McaCustGroupStaging] AS [CUS_GRP]
       ...
       LEFT JOIN [dbo].[McaCommissionCustomerGroupStaging] AS [CUS_COM_GRP]
       ...
       LEFT JOIN [dbo].[McasmmBusRelSalesDistrictGroupStaging] AS [CUS_SLE_DIS]
